...
export namespace spec {
	...
	export class BuildCompletionDataResponse {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.Body = this.convertValues(source["Body"], FetchCompletionData);
	    }
	...
	export class ConversationMessage {
	    ...
	    chatAttachments?: ConversationAttachment[];
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.chatAttachments = this.convertValues(source["chatAttachments"], ConversationAttachment);
	    }
