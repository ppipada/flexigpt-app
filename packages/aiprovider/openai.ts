...
export class OpenAIAPIProvider extends ProviderAPI implements CompletionProvider {
	constructor(
		apiKey: string,
		timeout: number,
...
export function getOpenAIProvider(): CompletionProvider {
	...
	return new OpenAIAPIProvider(apiKey, timeout, defaultCompletionModel, defaultChatCompletionModel, defaultOrigin);
}
