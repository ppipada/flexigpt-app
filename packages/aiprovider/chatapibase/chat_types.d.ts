export declare enum ChatCompletionRoleEnum {
    system = "system",
    user = "user",
    assistant = "assistant",
    function = "function"
...
export interface CompletionProvider {
    completion(input: CompletionRequest): Promise<{
        fullResponse: any;
        data: string | null;
    }>;
    checkAndPopulateCompletionParams(prompt: string | null, messages: Array<ChatCompletionRequestMessage> | null, inputParams?: {
        [key: string]: any;
    }): CompletionRequest;
